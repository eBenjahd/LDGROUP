...
from .views import ProductList, ProductDetail, update_inventory, get_inventory, update_order_item, create_order, get_csrf_token, get_all_inventory  # Ya no es necesario importar views
...
urlpatterns = [
    ...
    path('inventory/all', get_all_inventory, name='get-all-inventory'),
